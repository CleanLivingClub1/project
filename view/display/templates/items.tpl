...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Online Shopping - Clean living Club</title>
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop1.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Quasi Architects</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop2.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Byances Kcepte</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop3.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Cepturi Sintocc</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop4.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Excepteur Sint</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop5.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Occam Cupid</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop6.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Fugiat Nulla</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop7.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Eos Qui Ratione</a></h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="{$smarty.const.INDEX_URL}view/item-single.php"><img class="img-responsive" src="{$TEMPLATE}img/shopping/shop8.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
										<h4 class="pull-left"><a href="{$smarty.const.INDEX_URL}view/item-single.php">Natus Erwor Site</a></h4>
