...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Gallery - Clean living Club</title>
						...
						<div class="gallery-content">
							<div class="row">
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish1.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish1.jpg" class="gallery-img-link">
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish2.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish2.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish3.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish3.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish4.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish4.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish12.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish12.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish13.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish13.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish14.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish14.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish15.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish15.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish16.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish16.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish17.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish17.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish18.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish18.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
								...
								<div class="col-md-3 col-sm-4">
									...
									<div class="element">
										<!-- Image -->
										<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish19.jpg" alt=""/>
										<!-- Gallery Image Hover Effect -->
										<span class="gallery-img-hover"></span>
										<!-- Gallery Image Hover Icon -->
										<a href="{$TEMPLATE}img/dish/dish19.jpg" class="gallery-img-link">
											<i class="fa fa-search-plus hover-icon icon-left"></i>
										</a>
										<a href="#">
											<i class="fa fa-link hover-icon icon-right"></i>
