...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Reserve Seats - Clean Living Club</title>
								...
								<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="item active">
											<img class="img-responsive" src="{$TEMPLATE}img/booking/table1.jpg" alt="" />
										</div>
										<div class="item">
											<img class="img-responsive" src="{$TEMPLATE}img/booking/table2.jpg" alt="" />
										</div>
										<div class="item">
											<img class="img-responsive" src="{$TEMPLATE}img/booking/table3.jpg" alt="" />
										</div>
									</div>
