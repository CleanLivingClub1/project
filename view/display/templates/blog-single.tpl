...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Blog Single - Clean Living Club</title>
						...
						<div class="row">
							<div class="col-md-8">
										...
										<ul class="comment-list">
											<li class="comment">
												<a class="pull-left" href="#">
													<img class="avatar" src="{$TEMPLATE}img/user.jpg" alt="" />
												</a>
								...
								<div class="navigation button">  
									<div class="pull-left">
										<a href="{$smarty.const.INDEX_URL}view/blog.php" class="btn btn-danger btn-sm">&laquo; Previous Post</a>
									</div>
									<div class="pull-right">
										<a href="{$smarty.const.INDEX_URL}view/blog.php" class="btn btn-danger btn-sm">Next Post &raquo;</a>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="clearfix"></div>
