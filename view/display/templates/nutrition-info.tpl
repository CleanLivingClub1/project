...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Nutrition Info - Clean living Club</title>
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<div class="nutrition-item">
									...
									<!-- Image -->
									<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish9.jpg" alt="" />
									<!-- Paragraph -->
							...
							<div class="col-md-4 col-sm-4">
								...
								<div class="nutrition-item">
									...
									<h4>Vanilla Cake</h4>
									<!-- Image -->
									<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish10.jpg" alt="" />
									<!-- Paragraph -->
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, exercise.</p>
									<!-- Nutrition information table -->
									<div class="table-responsive">
							...
							<div class="col-md-4 col-sm-4">
								...
								<div class="nutrition-item">
									...
									<h4>Fried Fish</h4>
									<!-- Image -->
									<img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish11.jpg" alt="" />
									<!-- Paragraph -->
									<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, exercise.</p>
									<!-- Nutrition information table -->
									<div class="table-responsive">
