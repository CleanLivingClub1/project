...
<html>
	<head>
		...
		<!-- FlexSlider Css -->
		<link rel="stylesheet" href="{$TEMPLATE}css/flexslider.css" media="screen" />
		<!-- Portfolio CSS -->
	...
	<body>
				...
				<div class="tp-banner" >
					<ul>	<!-- SLIDE  -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							<!-- MAIN IMAGE -->
							<img src="{$TEMPLATE}img/slider/slide2.jpg"  alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption customin customout"
								...
								data-endspeed="300"
								style="z-index: 5"><img class="slide-img img-responsive" src="{$TEMPLATE}img/slider/s21.png" alt="" />
							</div>
							<!-- LAYER NR. 3.1 -->
							<div class="tp-caption customin customout"
								...
								data-easing="Power3.easeInOut"
								data-endspeed="300"
								style="z-index: 6"><img class="slide-img img-responsive" src="{$TEMPLATE}img/slider/s22.png" alt="" />
							</div>
							<!-- LAYER NR. 3.2 -->
							<div class="tp-caption customin customout"
								...
								data-easing="Power3.easeInOut"
								data-endspeed="300"
								style="z-index: 7"><img class="slide-img img-responsive" src="{$TEMPLATE}img/slider/s23.png" alt="" />
							</div>
							<!-- LAYER NR. 3.3 -->
							<div class="tp-caption customin customout"
								...
								data-easing="Power3.easeInOut"
								data-endspeed="300"
								style="z-index: 8"><img class="slide-img img-responsive" src="{$TEMPLATE}img/slider/s24.png" alt="" />
							</div>
						</li>
						<li data-transition="zoomin" data-slotamount="6" data-masterspeed="400" >
							<!-- MAIN IMAGE -->
							<img src="{$TEMPLATE}img/slider/transparent.png" style="background-color:#fff" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
							...
							<div class="tp-caption customin customout"
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"
								style="z-index: 3"><img class="img-responsive" src="{$TEMPLATE}img/slider/s11.png" alt="" />
							</div>
							<!-- LAYER NR. 2.1 -->
							<div class="tp-caption customin customout"
								data-x="right" 
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"
								style="z-index: 3"><img class="img-responsive" src="{$TEMPLATE}img/slider/s12.png" alt="" />
							</div>
							<!-- LAYER NR. 2.2 -->
							<div class="tp-caption customin customout"
								data-x="right" 
								...
								data-endspeed="500"
								data-endeasing="Power4.easeIn"
								style="z-index: 3"><img class="img-responsive" src="{$TEMPLATE}img/slider/s13.png" alt="" />
							</div>
							<!-- LAYER NR. 2.3 -->
						...
						<li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
							<!-- MAIN IMAGE -->
							<img src="{$TEMPLATE}img/slider/transparent.png" style="background-color:#fea501" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
							<!-- LAYERS NR. 1 -->
							<div class="tp-caption lfl"
								...
								data-captionhidden="off"><img class="img-responsive" src="{$TEMPLATE}img/slider/s35.png" alt="" />
							</div>
							<!-- LAYERS NR. 2 -->
						...
						<li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
							...
							<div class="tp-caption lfl"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="{$TEMPLATE}img/slider/s31.png" class="img-responsive" alt="" />
							</div>
							<!-- LAYERS NR. 2 -->
							<div class="tp-caption lfl"
								data-x="80"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="{$TEMPLATE}img/slider/s33.png" class="img-responsive" alt="" />
							</div>
							<!-- LAYERS NR. 3 -->
							<div class="tp-caption lfl"
								data-x="450"
								...
								data-endspeed="300"
								data-endeasing="Power4.easeIn"
								data-captionhidden="off"><img src="{$TEMPLATE}img/slider/s34.png" class="img-responsive" alt="" />
							</div>
							<!-- LAYERS NR. 4 -->
				...
				<div class="dishes padd">
					<div class="container">
						...
						<div class="default-heading">
							<!-- Crown image -->
							<img class="img-responsive" src="{$TEMPLATE}img/crown.png" alt="" />
							<!-- Heading -->
							<h2>New Dishes</h2>
							<!-- Paragraph -->
						...
						<div class="row">
							<div class="col-md-3 col-sm-6">	
								<div class="dishes-item-container">
									...
									<div class="img-frame">
										<!-- Image -->
										<img src="{$TEMPLATE}img/dish/dish5.jpg" class="img-responsive" alt="" />
							...
							<div class="col-md-3 col-sm-6">
								<div class="dishes-item-container">
									...
									<div class="img-frame">
										<!-- Image -->
										<img src="{$TEMPLATE}img/dish/dish6.jpg" class="img-responsive" alt="" />
										<!-- Block for on hover effect to image -->
										<div class="img-frame-hover">
											<!-- Hover Icon -->
											<a href="#"><i class="fa fa-cutlery"></i></a>
							...
							<div class="col-md-3 col-sm-6">
								<div class="dishes-item-container">
									...
									<div class="img-frame">
										<!-- Image -->
										<img src="{$TEMPLATE}img/dish/dish7.jpg" class="img-responsive" alt="" />
										<!-- Block for on hover effect to image -->
										<div class="img-frame-hover">
											<!-- Hover Icon -->
											<a href="#"><i class="fa fa-cutlery"></i></a>
							...
							<div class="col-md-3 col-sm-6">
								<div class="dishes-item-container">
									...
									<div class="img-frame">
										<!-- Image -->
										<img src="{$TEMPLATE}img/dish/dish8.jpg" class="img-responsive" alt="" />
										<!-- Block for on hover effect to image -->
										<div class="img-frame-hover">
											<!-- Hover Icon -->
											<a href="#"><i class="fa fa-cutlery"></i></a>
						...
						<div class="menu-container">
							<div class="row">
								<div class="col-md-4 col-sm-4">
									...
									<div class="menu-head">
										<!-- Image for menu item -->
										<img class="menu-img img-responsive img-thumbnail" src="{$TEMPLATE}img/menu/menu1.jpg" alt="" />
										<!-- Menu title / Heading -->
										<h3>Seafood</h3>
								...
								<div class="col-md-4 col-sm-4">
									...
									<div class="menu-head">
										<!-- Image for menu item -->
										<img class="menu-img img-responsive img-thumbnail" src="{$TEMPLATE}img/menu/menu2.jpg" alt="" />
										<!-- Menu title / Heading -->
										<h3>Chicken</h3>
										<!-- Border for above heading -->
								...
								<div class="col-md-4 col-sm-4">
									...
									<div class="menu-head">
										<!-- Image for menu item -->
										<img class="menu-img img-responsive img-thumbnail" src="{$TEMPLATE}img/menu/menu3.jpg" alt="" />
										<!-- Menu title / Heading -->
										<h3>Dessert</h3>
										<!-- Border for above heading -->
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish3.jpg" alt="" /></a>
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish2.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish4.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
							...
							<div class="col-md-6 col-sm-6">
								...
								<div class="pricing-item">
									<!-- Image -->
									<a href="#"><img class="img-responsive img-thumbnail" src="{$TEMPLATE}img/dish/dish1.jpg" alt="" /></a>
									<!-- Pricing item details -->
									<div class="pricing-item-details">
										<!-- Heading -->
						...
						<div class="row">
							<div class="col-md-4 col-sm-4">
								...
								<div class="chefs-member">
									...
									<div class="chefs-head">
										...
										<img class="chefs-back img-responsive" src="{$TEMPLATE}img/chef/c-back2.jpg" alt="" />
										<!-- chef member image -->
										<img class="chefs-img img-responsive" src="{$TEMPLATE}img/chef/4.jpg" alt="" />
									</div>
									<!--Name / Heading -->
							...
							<div class="col-md-4 col-sm-4">
								...
								<div class="chefs-member">
									...
									<div class="chefs-head">
										<!-- Member background image -->
										<img class="chefs-back img-responsive" src="{$TEMPLATE}img/chef/c-back1.jpg" alt="" />
										<!-- chef member image -->
										<img class="chefs-img img-responsive" src="{$TEMPLATE}img/chef/7.jpg" alt="" />
									</div>
									<!--Name / Heading -->
							...
							<div class="col-md-4 col-sm-4">
								...
								<div class="chefs-member">
									...
									<div class="chefs-head">
										<!-- Member background image -->
										<img class="chefs-back img-responsive" src="{$TEMPLATE}img/chef/c-back3.jpg" alt="" />
										<!-- chef member image -->
										<img class="chefs-img img-responsive" src="{$TEMPLATE}img/chef/2.jpg" alt="" />
									</div>
									<!--Name / Heading -->
								...
								<div class="flexslider-recent flexslider">
									<ul class="slides">
										<li>
											...
											<img class="img-responsive" src="{$TEMPLATE}img/dish/dish9.jpg" alt="" />
											<!-- Slide content -->
										...
										<li>
											<!-- Image for background -->
											<img class="img-responsive" src="{$TEMPLATE}img/dish/dish10.jpg" alt="" />
											<!-- Slide content -->
											<div class="slider-content">
												<!-- Heading -->
										...
										<li>
											<!-- Image for background -->
											<img class="img-responsive" src="{$TEMPLATE}img/dish/dish11.jpg" alt="" />
											<!-- Slide content -->
											<div class="slider-content">
												<!-- Heading -->
									...
									<ul class="slides">
										<li>
											...
											<div class="testimonial-item">
												...
												<!-- Heading with image -->
												<h4><img class="img-responsive img-circle" src="{$TEMPLATE}img/user.jpg" alt="" /> Jhon Doe<span>, your designation</span></h4>
												<div class="clearfix"></div>
											</div>
										</li>
										<li>
											...
											<div class="testimonial-item">
												...
												<!-- Heading with image -->
												<h4><img class="img-responsive img-circle" src="{$TEMPLATE}img/user.jpg" alt="" /> Marten<span>, your designation</span></h4>
												<div class="clearfix"></div>
											</div>
										</li>
										<li>
											...
											<div class="testimonial-item">
												...
												<!-- Heading with image -->
												<h4><img class="img-responsive img-circle" src="{$TEMPLATE}img/user.jpg" alt="" /> Katrina Doe<span>, your designation</span></h4>
												<div class="clearfix"></div>
											</div>
										</li>
									</ul>
		...
		<!-- FLEX SLIDER SCRIPTS  -->
		<script defer src="{$TEMPLATE}js/jquery.flexslider-min.js"></script>
		<!-- Pretty Photo JS -->
