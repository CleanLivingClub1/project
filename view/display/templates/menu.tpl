...
<html>
	<head>
		<meta charset="utf-8">
		<!-- Title here -->
		<title>Menu - Clean Living Club</title>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Seafoods</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu1.jpg" alt="" />
									<!-- Menu list items -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Chicken</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu2.jpg" alt="" />
									<!-- Menu list items -->
									<div class="menu-list-item">
										<!-- Heading / Dish name -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Dessert</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu3.jpg" alt="" />
									<!-- Menu list items -->
									<div class="menu-list-item">
										<!-- Heading / Dish name -->
										<h4 class="pull-left">Chicken Curie</h4>
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Drinks</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu4.jpg" alt="" />
									<!-- Menu list items -->
									<div class="menu-list-item">
										<!-- Heading / Dish name -->
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Pizza</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu5.jpg" alt="" />
									<!-- Menu list items -->
									<div class="menu-list-item">
										<!-- Heading / Dish name -->
										<h4 class="pull-left">Cold Drinks</h4>
							...
							<div class="col-md-4 col-sm-6">
								...
								<div class="menu-list">
									...
									<h3>Burger</h3>
									<!-- Image for menu list -->
									<img class="img-responsive" src="{$TEMPLATE}img/menu/menu6.jpg" alt="" />
									<!-- Menu list items -->
									<div class="menu-list-item">
										<!-- Heading / Dish name -->
										<h4 class="pull-left">Cold Drinks</h4>
